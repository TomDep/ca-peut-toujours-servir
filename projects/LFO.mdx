...
<Image src="/galerie/LFO/LFO1.jpg" alt="Illustration simple servant à tester les fonctionnalités." description="" />

<Audio src="/galerie/LFO/audio.mp3" description="Extrait sonore" />
