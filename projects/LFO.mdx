...
<Image src="/galerie/LFO/illustration.jpg" alt="Illustration simple servant à tester les fonctionnalités." description="Description de l'image rajoutant du contexte." />

<Audio src="/galerie/LFO/audio.mp3" description="Petite description de l'audio" />
...
<Video src="/galerie/LFO/video.mp4" title="Example video (optional title)" description="Example description where I say things under the video to add some context. This is separate from the text. This is optional" />
